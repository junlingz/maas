...
const INITIAL_DATASETS: DatasetRow[] = [
  ...
  { id: 3, name: "GSM8K", description: "小学数学应用题的多步推理评测集。", source: "public", modelType: "语言模型", tasks: ["逻辑推理", "问答"], format: "内置", count: 8792, domain: "数学推理", version: "v1.1", versions: ["v1.1", "v1.0"], recommendedVersion: "v1.1", status: "校验通过", permission: "公开", creator: "system", team: "系统", updatedAt: "2026-03-20 18:10:03", metrics: ["Accuracy", "Reasoning Score"], schema: "id,input,answer,rationale", sample: "{A shop sells 12 apples...}", citation: "Cobbe et al., Training Verifiers to Solve Math Word Problems", versionDetails: { "v1.1": { count: 8792, sample: "{\"A shop sells 12 apples...\"}", schema: "id,input,answer,rationale", citation: "Cobbe et al., Training Verifiers to Solve Math Word Problems, 2021", updatedAt: "2026-03-20", releaseNote: "补充 1300+ 道多步推理题；增加解题步骤标注。" }, "v1.0": { count: 7473, sample: "{\"If John has 5 apples...\"}", schema: "id,input,answer", citation: "Cobbe et al., Training Verifiers to Solve Math Word Problems, 2021", updatedAt: "2025-05-12", releaseNote: "GSM8K 数据集初始版本。" } } },
