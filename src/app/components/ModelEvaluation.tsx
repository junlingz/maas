...
const SAMPLE_RESULTS: EvaluationSample[] = [
  ...
  { id: "sample_002", prompt: "请概括合同中的付款周期。", output: "验收后 30 日内支付全部款项。", reference: "验收通过后 30 个工作日内支付。", verdict: "部分通过", score: 0.72, dataset: "TruthfulQA", taskType: "问答", category: "合同问答", difficulty: "中等", language: "中文" },
